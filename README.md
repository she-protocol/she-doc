[![License](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/she-protocol/she-docs/blob/main/LICENSE)
...
To standardize the documentation, please follow the [style guide](https://github.com/she-protocol/she-docs/blob/devrel/STYLE_GUIDE.mdx) for instructions on how to format changes to the docs.
...
Alternatively, if you have more general suggestions on how we can improve or correct these docs, you can [open an issue](https://github.com/she-protocol/she-docs/issues).
