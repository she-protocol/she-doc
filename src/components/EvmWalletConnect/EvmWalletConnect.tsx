...
import useSheAddress from '../../hooks/useSheAddress';
...
const WalletComponent = () => {
	...
	const response = useSheAddress({ chainId: getCosmosChainId(Number(network)) });
	const { data: sheAddress, isLoading } = response;
	...
	return (
		<div className='flex flex-col gap-4 mt-4'>
			...
			<div className='flex flex-col gap-2'>
				...
				<CopyText column={true} label='Cosmos Address:' value={sheAddress && !isLoading ? sheAddress : '---'} copyDisabled={!sheAddress || isLoading} />
