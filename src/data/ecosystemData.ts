...
export async function getSheEcosystemAppsData(): Promise<EcosystemResponse> {
	const url = 'https://app-api.shenetwork.io/webflow/ecosystem';
...
export async function getSheEcosystemAppByCategory(category: EcosystemDocsCategory): Promise<EcosystemResponse> {
	const url = `https://app-api.shenetwork.io/webflow/ecosystem/docs/${category}`;
	const headers = { Accept: 'application/json' };
