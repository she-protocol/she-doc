...
import shecasinoLogo from '../../public/assets/ecosystem/shecasino.png';
import shejinLogo from '../../public/assets/ecosystem/shejin.png';
...
import superSheyanBotLogo from '../../public/assets/ecosystem/supersheyanbot.jpeg';
...
export const appData: App[] = [
	{
		title: 'DragonSwap',
		description: 'The native DEX on SHE',
	...
	{
		title: 'SheCasino',
		description: 'Full-featured casino built natively on SHE',
		href: 'https://shecasino.io',
		image: shecasinoLogo,
		tags: [Tag.BET, Tag.GAMES]
	},
	{
		title: 'WeBump',
		description: 'SHE native NFT launchpad',
	...
	{
		title: 'Shejin',
		description: 'Launchpad on SHE',
		href: 'https://shejin.app/staking',
		image: shejinLogo,
	...
	{
		title: 'Silo',
		description: 'Liquid staking and MEV on SHE',
	...
	{
		title: 'Yaka',
		description: 'Algebra Integral fork on SHE',
	...
	},
	{
		...
		href: 'https://testnet.accumulated.finance/stake/she',
	...
	},
	{
		...
		href: 'https://jelly-verse-she.vercel.app/jellyswap',
		image: jellyverseLogo,
		tags: [Tag.DEFI, Tag.TRADE, Tag.LIQ]
	},
	{
		title: 'Super Sheyan Bot',
		description: 'SHE native telegram trading bot',
		href: 'https://t.me/SSheyanEvmBot',
		image: superSheyanBotLogo,
		tags: [Tag.TRADE, Tag.BOT, Tag.DEFI]
	},
	{
		title: 'NFTs2ME',
		description: 'No-code NFT creation tool',
		href: 'https://nfts2me.com/app/she-devnet/',
		image: nfts2meLogo,
	...
	},
	{
		...
		href: 'https://test-app.stafi.io/gallery/evm/SHE/?net=SHE',
		image: stafiLogo,
	...
	},
	{
		...
		href: 'https://alpha.jasper.finance/trade/she',
	...
	},
	{
		...
		href: 'https://academy.subquery.network/indexer/quickstart/quickstart_chains/cosmos-she.html',
		image: SubGraphLogo,
		tags: [Tag.INDEX]
	},
	{
		title: 'Wormhole',
		description: 'A popular bridge for transferring assets across multiple blockchains.',
	...
	{
		title: 'Squid',
		description: 'Enables one-click cross-chain swaps across various EVM blockchains.',
	...
	{
		title: 'Pyth',
		description: 'A decentralized data oracle network providing high-fidelity real-time financial market data to smart contracts.',
	...
	{
		title: 'Coinbase',
		description: 'A leading cryptocurrency exchange platform in the U.S., known for its user-friendly interface and secure trading environment.',
	...
	{
		title: 'Binance',
		description: 'The world’s largest cryptocurrency exchange by trading volume, offering a wide range of digital assets and advanced trading features.',
	...
	{
		title: 'Rhino',
		description: 'Provides robust RPC services for seamless blockchain interactions.',
	...
	},
	{
		title: 'QuickNode',
		description:
			'A trusted infrastructure partner for the SHE network, providing developers with powerful APIs and dedicated support to streamline their blockchain applications.',
	...
	},
	{
		...
		href: 'https://polkachu.com/networks/she',
		image: PolkachuLogo,
		tags: [Tag.RPC]
	},
	{
