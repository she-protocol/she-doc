...
export default withNextra({
	...
	async redirects() {
		return [
			...
			{
				"source": "/user-guides/wrapped-she",
				"destination": "/learn/wrapped-she",
				"permanent": true
			},
			{
			...
			{
				"source": "/dev-node/running-shed",
				"destination": "/node/running-shed",
				"permanent": true
			},
			{
			...
			{
				"source": "/shed/:slug*",
				"destination": "/reference/shed/:slug*",
				"permanent": true
			},
			{
				"source": "/shed",
				"destination": "/reference/shed",
				"permanent": true
			},
			{
				"source": "/dev-tutorials/installing-shed",
				"destination": "/build/installing-shed",
				"permanent": true
			},
			{
