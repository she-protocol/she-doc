...
Most development resources for developing with Soldity on Ethereum Mainnet also apply to development on SHE.

This page suggests a minimal set of resources for getting started with building a decentralized app for SHE EVM.
