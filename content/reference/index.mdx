...
Explore SHE’s core reference materials, endpoints, commands, and more.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
	<LinkCard
		...
		preview={{
			content: 'An overview of SHE’s EVM layer and cross-chain capabilities.',
    ...
    <LinkCard
    	...
    	preview={{
    		content: 'How pointer contracts link on-chain logic to off-chain data sources in SHE.',
    ...
    <LinkCard
    	...
    	description="Interact with native SHE modules from the EVM"
    	preview={{
    ...
    <LinkCard
    	...
    	preview={{
    		content: 'Explore how SHE leverages Cosmos-SDK modules and IBC features.',
