...
- `getExchangeRates`: Gets the corresponding SHE Address from the given EVM
  Address
...
<Callout type="info">View the Oracle precompile source code and the contract ABI [here](https://github.com/she-protocol/she-chain/tree/main/precompiles/oracle).</Callout>
