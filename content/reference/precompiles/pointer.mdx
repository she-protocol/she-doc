...
- `addCW20Pointer`: Adds a CW721 pointer for the contract.
  ...
  ```
  <Callout type="info">View the Pointer precompile source code and the contract ABI [here](https://github.com/she-protocol/she-chain/tree/main/precompiles/pointer).</Callout>
  ```
