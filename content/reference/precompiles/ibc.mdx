...
<Callout type="info">View the IBC precompile source code and the contract ABI [here](https://github.com/she-protocol/she-chain/tree/main/precompiles/ibc).</Callout>
