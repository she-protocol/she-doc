...
- `getCW721Pointer`: Retrieves the pointer address, version, and existence
  ...
  ```
  <Callout type="info">View the PointerView precompile source code and the contract ABI [here](https://github.com/she-protocol/she-chain/tree/main/precompiles/pointerview).</Callout>
  ```
