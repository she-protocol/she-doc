...
This precompile enables participation in SHE's governance process through the
...
<Callout type="info">View the Governance precompile source code and the contract ABI [here](https://github.com/she-protocol/she-chain/tree/main/precompiles/gov).</Callout>
