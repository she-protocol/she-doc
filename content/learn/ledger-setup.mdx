...
# Using Ledger Hardware Wallets on SHE

## Introduction

The SHE network supports various crypto assets, including:

- SHE tokens (SHE, custom tokenfactory tokens)
- CW20 tokens
- CW721 NFTs
- ERC20 tokens
- ERC721 NFTs
...
with the SHE network, which supports various crypto assets, including:
...
- A compatible wallet application for SHE network (refer to SHE documentation
...
4. **Install the SHE App on Ledger**:
   - In Ledger Live, go to **Manager**.
   - Connect and unlock your Ledger device.
   - Search for "SHE" in the App Catalog and click **Install**.

<Callout type="info">Linux users will need to add a `udev rule` to allow access to the device. You can find the script to add a rule in the Ledger repo [here](https://github.com/LedgerHQ/udev-rules).</Callout>
...
1. **Connect Your Ledger Device**:
   ...
   - Open your compatible SHE network wallet application.
   - Connect your Ledger device to your computer.
   - Unlock your Ledger device and open the SHE app.

2. **Access the SHE Network**:
...
1. Open your SHE network wallet application.
2. Ensure your Ledger device is connected and the SHE app is open.
...
<Callout type="warning">Always verify the receiver address on your Ledger device before sharing it. This prevents attacks like address spoofing.</Callout>
...
<Callout type="warning">Always double-check the transaction details on your Ledger device before confirming. This is your last line of defense against potential attacks or errors.</Callout>

## Support

For further assistance, you can reach out to the following support channels:

- **SHE Network Community**: Join the official SHE network community
  [Telegram](https://t.me/shenetwork) or [Discord](https://discord.gg/she).
- **Ledger Support**: For Ledger-specific issues, visit the
  [Ledger Support Center](https://support.ledger.com/hc/en-us).
- **Wallet Support**: For wallet-related questions, check the support resources
  provided by your chosen wallet application.

## Additional Resources

- **SHE Network Documentation**: Detailed information about the SHE network is
  available in the [official documentation](https://www.docs.she.io/).
- **Ledger Academy**: Learn more about cryptocurrency security on the official
  [Ledger Academy](https://www.ledger.com/academy).

<Callout type="error">Never share your recovery phrase with anyone. Keep it in a safe, offline location. Your recovery phrase is the only way to restore access to your funds if your device is lost or damaged.</Callout>
