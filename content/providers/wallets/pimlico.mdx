...
[Pimlico](https://pimlico.io) is an Account Abstraction infrastructure provider that enables developers to easily integrate smart accounts and gasless transactions into their SHE applications. This guide will walk you through creating a smart account and sending your first gasless transaction on SHE Testnet using Pimlico's infrastructure.

## Getting Started

### Dependencies

To integrate Pimlico into your SHE application, you'll need to install the following dependencies:
...
export const publicClient = createPublicClient({
  chain: sheTestnet,
  transport: http('https://evm-rpc-testnet.she-apis.com')
});

// Create Pimlico client
const pimlicoUrl = `https://api.pimlico.io/v2/${sheTestnet.id}/rpc?apikey=${apiKey}`;
