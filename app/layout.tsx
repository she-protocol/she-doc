	...
	return (
		<html lang='en' dir='ltr' suppressHydrationWarning style={{ width: '100%', height: '100%' }}>
			<head>
				...
				<link rel='canonical' href='https://docs.she.io' />

				<meta name='keywords' content='SHE, SHE Network, SHE Blockchain, SHE Docs, SHE Documentation' />
				<meta name='author' content='SHE Network' />
			</head>
